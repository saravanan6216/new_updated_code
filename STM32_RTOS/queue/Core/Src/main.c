...
/* Private variables ---------------------------------------------------------*/
osThreadId senderTaskHPHandle;
osThreadId senderTaskLPHandle;
...
/* USER CODE BEGIN Header_senderfunHP */
/**
  * @brief  Function implementing the senderTaskHP thread.
...
/* USER CODE BEGIN Header_senderFunLP */
/**
* @brief Function implementing the senderTaskLP thread.
* @param argument: Not used
* @retval None
*/
...
void senderFunLP(void const * argument)
{
  ...
  /* USER CODE END senderFunLP */
}

/* USER CODE BEGIN Header_receiverfun */
/**
